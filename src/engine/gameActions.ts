...
export type GameAction =
  | { type: 'COMPLETE_CHALLENGE'; payload: { challengeId: string; hintsUsed: number; attempts: number; challengeType: string } }
  | { type: 'NEXT_CHALLENGE' }
  | { type: 'NEXT_LEVEL' }
...
export const gameActions = {
  completeChallenge: (challengeId: string, hintsUsed: number, attempts: number, challengeType: string): GameAction => ({
